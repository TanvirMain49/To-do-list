      ...
      <div class="grid md:grid-cols-2 items-center gap-8 h-full">
        <form class="max-w-lg max-md:mx-auto w-full p-6">
          <div class="mb-12">
            ...
            <p class="text-gray-500 text-sm mt-6">Immerse yourself in a hassle-free login journey with our intuitively designed login form. Effortlessly access your account.</p>
          </div>
          ...
          <div class="mt-8">
            <button type="button" class="w-full shadow-xl py-2.5 px-4 text-sm tracking-wide font-semibold rounded-md text-white bg-blue-600 hover:bg-blue-700 focus:outline-none">
              Log in
            </button>
          </div>
          <p class="text-sm mt-8 text-center text-gray-500">Don't have an account? <a href="javascript:void(0);" class="text-blue-600 font-semibold tracking-wide hover:underline ml-1">Register here</a></p>
        </form>
